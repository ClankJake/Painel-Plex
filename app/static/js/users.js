...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderUserCard(user) {
        ...
        card.innerHTML = `
            ...
            <div class="flex items-center justify-end flex-wrap gap-1 mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
        ...
        if (action === 'copy-payment-link') {
            if (user.payment_token) {
                ...
                navigator.clipboard.writeText(paymentUrl).then(() => {
                    showToast(i18n.paymentLinkCopied, 'success');
                }).catch(() => {
