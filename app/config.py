    ...
    if not os.path.exists(CONFIG_FILE):
        ...
        try:
            ...
            message_template_defaults = {
                ...
                "PUSH_TRIAL_EXTENDED_TITLE_TEMPLATE": DEFAULT_TEMPLATES.get("PUSH_TRIAL_EXTENDED_TITLE_TEMPLATE", ""),
                "PUSH_TRIAL_EXTENDED_MESSAGE_TEMPLATE": DEFAULT_TEMPLATES.get("PUSH_TRIAL_EXTENDED_MESSAGE_TEMPLATE", ""),
