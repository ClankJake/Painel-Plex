...
def api_settings():
    if request.method == 'POST':
        ...
        fields_to_update = [
            ...
            'TELEGRAM_TRIAL_EXTENDED_MESSAGE_TEMPLATE', 'WEBHOOK_TRIAL_EXTENDED_MESSAGE_TEMPLATE',
            ...
            'REFERRAL_DEFAULT_INVITE_CODE', 'REFERRAL_MAX_REWARDS_PER_USER',
            ...
            'DISCORD_TRIAL_EXTENDED_MESSAGE_TEMPLATE',
            ...
            'PUSH_TRIAL_EXTENDED_TITLE_TEMPLATE', 'PUSH_TRIAL_EXTENDED_MESSAGE_TEMPLATE',
        ...
        numeric_fields = [
            ...
            'ACHIEVEMENT_NIGHT_OWL_BRONZE', 'ACHIEVEMENT_NIGHT_OWL_SILVER', 'ACHIEVEMENT_NIGHT_OWL_GOLD',
            'ACHIEVEMENT_PIONEER_BRONZE', 'ACHIEVEMENT_PIONEER_SILVER', 'ACHIEVEMENT_PIONEER_GOLD', 'ACHIEVEMENT_PIONEER_WINDOW_HOURS',
            'STREAM_CHECK_INTERVAL_SECONDS', 'BACKUP_MAX_COUNT', 'XP_BONUS_PER_COMPLETED_ITEM', 'XP_COMPLETION_THRESHOLD_PERCENT', 'REFERRAL_REWARD_DAYS', 'REFERRAL_MAX_REWARDS_PER_USER', 'PRORATION_MIN_DAYS',
            'RECOMMENDATIONS_HISTORY_DAYS', 'RECOMMENDATIONS_MIN_PERCENT_WATCHED', 'RECOMMENDATIONS_MIN_CO_OCCURRENCE',
            'RECOMMENDATIONS_MAX_SECTIONS', 'RECOMMENDATIONS_ITEMS_PER_SECTION', 'RECOMMENDATIONS_GENRE_LOOKUP_LIMIT'
        ]
        ...
        float_fields = ['XP_PER_MINUTE_WATCHED', 'REFERRAL_REWARD_CREDIT', 'PRORATION_MIN_CHARGE', 'GATES2B_MIN_AMOUNT', 'MERCADOPAGO_MIN_AMOUNT',
                        # A pausa do envio em massa é sub-segundo (0.2): como int
                        # seria truncada para 0 e o campo perderia o sentido.
                        'BULK_SEND_INTERVAL_SECONDS']
